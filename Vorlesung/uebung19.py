...
net = cv2.dnn.readNet('models/frozen_inference_graph_ssd.pb', 'models/ssd_mobilenet_v2_coco_2018_03_29.pbtxt')
...
conf_thresh = 0.9  # TODO: play with this value
...
while cap.isOpened():
    ...
    if ret:
        ...
        for detection in output[0, 0, :, :]:
            ...
            confidence = np.max(np.exp(detection) / np.sum(np.exp(detection)))
